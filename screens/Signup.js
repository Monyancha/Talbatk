...
export default class Signup extends React.Component {
    ...
    render_signup(){
      if(this.state.signing == false){
        return <Button    onPress={() => {   this.registerUser()  }}  color='white'backgroundColor={Colors.mainColor} containerViewStyle={{borderRadius:15}} borderRadius={15} buttonStyle={{ padding: 10 }} textStyle={{ fontFamily: 'Droid Arabic Kufi' }} title="انشاء الحساب" />
      }
      else {
