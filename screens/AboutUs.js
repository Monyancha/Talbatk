    ...
    render() {
        return (
            <ScrollView style={{ backgroundColor: '#FCFFFD', height: '100%' }}>
                ...
                <Text style={{ fontFamily:'Droid Arabic Kufi',color: Colors.mainColor,textAlign:'center', backgroundColor: 'transparent', fontWeight: 'bold', fontSize: 18, margin: 12, marginTop: 20}}>عن تطبيق طلباتك</Text>
